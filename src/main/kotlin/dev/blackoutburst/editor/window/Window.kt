package dev.blackoutburst.editor.window

import dev.blackoutburst.editor.input.Keyboard
import dev.blackoutburst.editor.input.Mouse
import dev.blackoutburst.editor.maths.Vector2i
import dev.blackoutburst.editor.utils.IOUtils
import dev.blackoutburst.editor.utils.Time
import dev.blackoutburst.editor.utils.stack
import dev.blackoutburst.editor.window.callbacks.*
...
object Window {
    val title = MemoryStack.stackPush().UTF8("2D Editor")
    var id = -1L
    var isOpen = false
